...
begin
    -- update issue set `issuer` = null where `issuer` = user_id_delete;
    -- update issue set assignee = null where assignee = user_id_delete;
    -- delete from project_role where user_id = user_id_delete;
