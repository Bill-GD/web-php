...
class PageComponent {
      ...
      <header class="navbar bg-dark fixed-top border-dark-subtle border-bottom py-2">
        <div class="container">
          <a class="navbar-brand text-white" href="/">
            <svg class="svg-white pb-1" height="32" width="32" viewBox="0 0 512 512">
  ...
  static function alert_danger(string $error_message): string {
    ...
    <div class="alert alert-danger row m-0 mb-2" role="alert">
      <svg class="svg-white" height="16" width="16" viewBox="0 0 16 16" fill="#ff7984" class="h-100 mt-2 col-2">
        <path
